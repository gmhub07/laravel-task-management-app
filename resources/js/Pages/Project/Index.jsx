                                ...
                                <table className="w-full text-sm text-left rtl:text-right text-grey-500 dark-text-gray-400">
                                    ...
                                    <tbody>
                                        {projects.data.map((project) => (
                                            <tr className="bg-white border-b white:bg-gray-800 dark:border-grey-700" key={project.id}>
                                                <td className="px-3 py-2">{project.id}</td>
                                                <td className="px-3 py-2">
                                                    <img src={'/images/project-fallback.jpg' || project.image_path} style={{ width: 60 }} alt="image" />
                                                </td>
